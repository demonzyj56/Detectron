...
class RandomSampleCrop(object):
    ...
    Return:
        (img, boxes, classes)
            ...
            labels (Tensor): the class labels for each bbox
    """
    def __init__(self, sample_options=None, min_scale=0.3, max_scale=1.0,
    ...
    def __call__(self, image, boxes=None, labels=None):
        ...
        while True:
            ...
            for _ in range(50):
                ...
                w = random.uniform(self.min_scale * width, self.max_scale * width)
                h = random.uniform(self.min_scale * height, self.max_scale * height)
...
class Augmentations(object):
    """Data augmentation for SSD.
    Input:
        image: 3-D float tensor with BGR order.
        boxes: Nx4 tensor giving grouth truth locations in [x1, y1, x2, y2]
            ordering, and absolute coordiates.
        labels: Nx1 tensor giving grouth truth classes.
    """
    def __init__(self, size, mean, expand_factor=None, crop_factor=None):
        self.mean = mean
        self.size = size
